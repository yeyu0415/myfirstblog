...
``` bash
Google Web Toolkit（GWT Web Toolkit，简写：GWT） [1]  ，是一种允许开发人员使用 Java 编程语言快速构建和维护复杂但性能高的 JavaScript 前端应用程序的工具集，能够降低开发难度，尤其是与 Eclipse Google 插件结合使用时，优势更明显。有了 GWT可以使用 Java 编程语言编写 AJAX 前端，然后 GWT 会交叉编译到优化的JavaScript 中，而 JavaScript 可以自动在所有主要浏览器上运行。 [2] 
...
### [参考地址](https://baike.baidu.com/item/GWT/6513689)
